...
<div class="feature-showcase feature-showcase--immersive">
  ...
  <article id="compare" class="feature-card feature-card--compare reveal">
    ...
    <div class="feature-card__copy"><p class="feature-card__number">02 / COMPARE</p><h2>価格を比べる</h2><h3>ECと店頭の価格を、単価まで比べる</h3><p>楽天市場、Yahoo!ショッピングなどの結果と店頭価格を並べて比較。送料、内容量、個数、新品・中古の条件を確認しながら、単価でも判断できます。</p><p class="feature-card__hint">価格・在庫・送料は取得時点の参考情報です。購入前に販売元の最新情報を確認してください。</p></div>
  </article>
